...
**(Total Case, Total Deaths)**  
    ...
    - Quan hệ nhân quả: nếu `Total Case` tăng 1 thì `Total Deaths` tăng 0.018922  
...
**(Total Case, Total Recovered)**  
    ...
    - Quan hệ nhân quả: nếu `Total Case` tăng 1 thì `Total Recovered` tăng 0.793753   
...
**(Total Case, Total Tests)**  
    ...
    - Quan hệ nhân quả: nếu `Total Case` tăng 1 thì `Total Tests` tăng 12.685115  
...
**(Total Deaths, Total Recovered)**  
    ...
    - Quan hệ nhân quả: nếu `Total Deaths` tăng 1 thì `Total Recovered` tăng 38.122409  
...
**(Total Recovered, Total Tests)**  
    ...
    - Quan hệ nhân quả: nếu `Total Recovered` tăng 1 thì `Total Tests` tăng 15.606073  
